...
main (i32 argc, char *argv[])
{
  ...
  lapack_int info;
  f64 *matrix_a, *matrix_a_copy, *matrix_a_ref, *matrix_a_compute,*matrix_u_compute,  *matrix_u_ref, *matrix_atr,  *matrix_u1, *matrix_u2, *matrix_c, *matrix_b1, *matrix_b2,
      *matrix_v1, *matrix_tmp, *matrix_v2, *matrix_v_compute, *matrix_v_ref, *eval_v, *eval, *sigma, *res, *res2, *matrix_ut, *eval_ref, *superb, *sigma_ref, *matrix_tmp_ref, error_lapack, error_compute, error_vs;
